...
public static LinkedHashMap<_cls_benchmark1,_cls_benchmark1> _cls_benchmark1_instances;
...
_cls_benchmark1_instances = new LinkedHashMap<_cls_benchmark1,_cls_benchmark1>();
}
...
_cls_benchmark0.pw.println("[lessThan5]MOVED ON METHODCALL: "+ _info +" TO STATE::> " + state_format);
