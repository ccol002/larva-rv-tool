...
public static LinkedHashMap<_cls_clocks0,_cls_clocks0> _cls_clocks0_instances;
...
_cls_clocks0_instances = new LinkedHashMap<_cls_clocks0,_cls_clocks0>();
try{
pw = new PrintWriter("{{OUTPUT_DIR}}/output_clocks.txt");
...
public void _goto_test1(String _info){
 String state_format = _string_test1(_state_id_test1, 1);
 if (state_format.startsWith("!!!SYSTEM REACHED BAD STATE!!!")) {
_cls_clocks0.pw.println("[test1]MOVED ON METHODCALL: "+ _info +" TO STATE::> " + state_format);
...
public void _goto_test2(String _info){
 String state_format = _string_test2(_state_id_test2, 1);
 if (state_format.startsWith("!!!SYSTEM REACHED BAD STATE!!!")) {
_cls_clocks0.pw.println("[test2]MOVED ON METHODCALL: "+ _info +" TO STATE::> " + state_format);
_cls_clocks0.pw.flush();
}
}
