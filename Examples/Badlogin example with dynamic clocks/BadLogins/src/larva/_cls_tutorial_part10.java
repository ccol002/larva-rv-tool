...
try{
RunningClock.start();
pw = new PrintWriter("/Volumes/ACMSAC 2017/BadLogins/src//output_tutorial_part1.txt");
...
if (0==1){}
		...
		if (1==0){}
		else if ((_occurredEvent(_event,0/*badlogin*/)) && (count >3 )){
		_cls_tutorial_part10.pw .println ("More than 3 bad logins!!!");

		_state_id_badlogins = 0;//moving to state bad
...
_cls_tutorial_part10.pw.println("[badlogins]MOVED ON METHODCALL: "+ _info +" TO STATE::> " + state_format);
_cls_tutorial_part10.pw.flush();
}
...
case 0: if (_mode == 0) return "bad"; else return "!!!SYSTEM REACHED BAD STATE!!! bad "+new _BadStateExceptiontutorial_part1().toString()+" ";
