...
public static LinkedHashMap<_cls_bank1,_cls_bank1> _cls_bank1_instances = new LinkedHashMap<_cls_bank1,_cls_bank1>();
...
public static _cls_bank1 _get_cls_bank1_inst( User u) { synchronized(_cls_bank1_instances){
...
synchronized(_cls_bank1_instances){
...
_cls_bank2[] a2 = new _cls_bank2[1];
synchronized(_cls_bank2._cls_bank2_instances){
a2 = _cls_bank2._cls_bank2_instances.keySet().toArray(a2);}
for (_cls_bank2 _inst : a2)
if (_inst != null
...
_cls_bank1[] a = new _cls_bank1[1];
synchronized(_cls_bank1_instances){
a = _cls_bank1_instances.keySet().toArray(a);}
for (_cls_bank1 _inst : a)
...
_cls_bank0.pw.println("[account]AUTOMATON::> account("+u + " " + ") STATE::>"+ _string_account(_state_id_account, 0));
_cls_bank0.pw.flush();
...
_cls_bank0.pw.println("[account]MOVED ON METHODCALL: "+ _info +" TO STATE::> " + _string_account(_state_id_account, 1));
_cls_bank0.pw.flush();
}
