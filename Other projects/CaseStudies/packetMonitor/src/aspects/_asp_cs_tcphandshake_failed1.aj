...
import larva.*;
public aspect _asp_cs_tcphandshake_failed1 {
...
if (!initialized){
	initialized = true;
	_cls_cs_tcphandshake_failed1.initialize();
}
}
...
_cls_cs_tcphandshake_failed1.rSYN = rSYN;
_cls_cs_tcphandshake_failed1.sSYNACK = sSYNACK;
_cls_cs_tcphandshake_failed1.rACK = rACK;
synchronized(_c){
 if (_c != null && _c._inst != null) {
_c._inst._call(thisJoinPoint.getSignature().toString(), 6/*c3AT1*/, 8/*all*/);
}
}
}
...
_cls_cs_tcphandshake_failed1 _cls_inst = _cls_cs_tcphandshake_failed1._get_cls_cs_tcphandshake_failed1_inst( ip,ip2,port1,port2);
