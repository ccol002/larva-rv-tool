...
//Trigger is the generic notion of an event... there are two main kinds of triggers: Event, EventCollection
	
	//The class Events does not inherit from Trigger but from Compiler
