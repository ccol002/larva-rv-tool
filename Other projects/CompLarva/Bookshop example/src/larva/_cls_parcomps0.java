...
public class _cls_parcomps0 implements _callable{

public static PrintWriter pw; 
public static _cls_parcomps0 root;
public static Channel c_purchase_start = new Channel();
public static Channel c_purchase_done = new Channel();

public static LinkedHashMap<_cls_parcomps0,_cls_parcomps0> _cls_parcomps0_instances = new LinkedHashMap<_cls_parcomps0,_cls_parcomps0>();
...
try{
RunningClock.start();
pw = new PrintWriter("C:\\Users\\Christian\\Desktop\\projects\\Bookshop example\\src//output_parcomps.txt");

root = new _cls_parcomps0();
_cls_parcomps0_instances.put(root, root);
  root.initialisation();
}catch(Exception ex)
{ex.printStackTrace();}
}

_cls_parcomps0 parent; //to remain null - this class does not have a parent!

public static void initialize(){}
//inheritance could not be used because of the automatic call to super()
//when the constructor is called...we need to keep the SAME parent if this exists!

public _cls_parcomps0() {
}

public void initialisation() {

_cls_parcomps0.pw .println ("Starting State");
...
public static _cls_parcomps0 _get_cls_parcomps0_inst() { synchronized(_cls_parcomps0_instances){
 return root;
}
}

public boolean equals(Object o) {
 if ((o instanceof _cls_parcomps0))
{return true;}
else
{return false;}
}
...
synchronized(_cls_parcomps0_instances){
...
_cls_parcomps0[] a = new _cls_parcomps0[1];
synchronized(_cls_parcomps0_instances){
a = _cls_parcomps0_instances.keySet().toArray(a);}
for (_cls_parcomps0 _inst : a)
...
if (--no_automata == 0){
synchronized(_cls_parcomps0_instances){
_cls_parcomps0_instances.remove(this);}
}
...
_cls_parcomps0.pw.println("[transaction]AUTOMATON::> transaction("+") STATE::>"+ _string_transaction(_state_id_transaction, 0));
_cls_parcomps0.pw.flush();
...
_cls_parcomps0.pw .println ("Error State");
...
_cls_parcomps0.pw.println("[transaction]MOVED ON METHODCALL: "+ _info +" TO STATE::> " + _string_transaction(_state_id_transaction, 1));
_cls_parcomps0.pw.flush();
}

public String _string_transaction(int _state_id, int _mode){
switch(_state_id){
case 1: if (_mode == 0) return "E"; else return "!!!SYSTEM REACHED BAD STATE!!! E "+new _BadStateExceptionparcomps().toString()+" ";
...
_cls_parcomps0.pw.println("[purchase]AUTOMATON::> purchase("+") STATE::>"+ _string_purchase(_state_id_purchase, 0));
_cls_parcomps0.pw.flush();
...
_cls_parcomps0.pw .println ("State");
...
_cls_parcomps0.pw.println("[purchase]MOVED ON METHODCALL: "+ _info +" TO STATE::> " + _string_purchase(_state_id_purchase, 1));
_cls_parcomps0.pw.flush();
}

public String _string_purchase(int _state_id, int _mode){
switch(_state_id){
case 5: if (_mode == 0) return "E"; else return "!!!SYSTEM REACHED BAD STATE!!! E "+new _BadStateExceptionparcomps().toString()+" ";
