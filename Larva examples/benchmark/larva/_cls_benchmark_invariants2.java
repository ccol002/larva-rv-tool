...
public class _cls_benchmark_invariants2 implements _callable{

public static LinkedHashMap<_cls_benchmark_invariants2,_cls_benchmark_invariants2> _cls_benchmark_invariants2_instances;

_cls_benchmark_invariants1 parent;
...
_cls_benchmark_invariants2_instances = new LinkedHashMap<_cls_benchmark_invariants2,_cls_benchmark_invariants2>();
}
//inheritance could not be used because of the automatic call to super()
//when the constructor is called...we need to keep the SAME parent if this exists!

public _cls_benchmark_invariants2( Transaction t,User u) {
parent = _cls_benchmark_invariants1._get_cls_benchmark_invariants1_inst( u);
c = new Clock(this,"c");
getAmount_enb = false;
c.register(2000l);
this.t = t;
...
public static _cls_benchmark_invariants2 _get_cls_benchmark_invariants2_inst( Transaction t,User u) { synchronized(_cls_benchmark_invariants2_instances){
_cls_benchmark_invariants2 _inst = new _cls_benchmark_invariants2( t,u);
if (_cls_benchmark_invariants2_instances.containsKey(_inst))
{
_cls_benchmark_invariants2 tmp = _cls_benchmark_invariants2_instances.get(_inst);
if ( tmp.getAmount_enb && !tmp.getAmount_temp.equals(t.getAmount() )){
  System.out.println(" Invariant Check: getAmount Failed: t.getAmount() !!: ");
tmp.getAmount_temp = t.getAmount() ;
}
 return _cls_benchmark_invariants2_instances.get(_inst);
}
else
{
 _inst.initialisation();
 _cls_benchmark_invariants2_instances.put(_inst,_inst);
 return _inst;
}
}
}
...
public boolean equals(Object o) {
 if ((o instanceof _cls_benchmark_invariants2)
 && (t == null || t.equals(((_cls_benchmark_invariants2)o).t))
 && (parent == null || parent.equals(((_cls_benchmark_invariants2)o).parent)))
{return true;}
else
{return false;}
}
...
synchronized(_cls_benchmark_invariants2_instances){
...
_cls_benchmark_invariants2[] a = new _cls_benchmark_invariants2[1];
synchronized(_cls_benchmark_invariants2_instances){
a = _cls_benchmark_invariants2_instances.keySet().toArray(a);}
for (_cls_benchmark_invariants2 _inst : a)
...
if (--no_automata == 0){
synchronized(_cls_benchmark_invariants2_instances){
_cls_benchmark_invariants2_instances.remove(this);}
synchronized(c){
c.off();
c._inst = null;
c = null;}
...
public void _goto_settingAmount(String _info){
 ...
 if (state_format.startsWith("!!!SYSTEM REACHED BAD STATE!!!")) {
   System.out.println("[settingAmount]MOVED ON METHODCALL: "+ _info +" TO STATE::> " + state_format);
}
}

public String _string_settingAmount(int _state_id, int _mode){
switch(_state_id){
case 2: if (_mode == 0) return "bad"; else return "!!!SYSTEM REACHED BAD STATE!!! bad "+new _BadStateExceptionbenchmark_invariants().toString()+" ";
...
public void _goto_retryTimeoutandExceptionRetry(String _info){
 ...
 if (state_format.startsWith("!!!SYSTEM REACHED BAD STATE!!!")) {
   System.out.println("[retryTimeoutandExceptionRetry]MOVED ON METHODCALL: "+ _info +" TO STATE::> " + state_format);
}
}
...
case 6: if (_mode == 0) return "bad"; else return "!!!SYSTEM REACHED BAD STATE!!! bad "+new _BadStateExceptionbenchmark_invariants().toString()+" ";
